 ...
 */
class SplashTemplate2Activity : VslTemplate2SplashActivity() {
    private companion object {
        private const val TAG: String = "SplashTemplate2Activity"
    }
    ...
    private fun getLanguageConfig(): LanguageConfig {
        return LanguageConfig(
            ...
            listLanguage = listOf(
                VslTemplate2LanguageModel(null, "France", "fr"),
                VslTemplate2LanguageModel(null, "English", "en"),
                VslTemplate2LanguageModel(null, "Hindi", "hi"),
                VslTemplate2LanguageModel(null, "Spanish", "es"),
                VslTemplate2LanguageModel(null, "China", "zh"),
                VslTemplate2LanguageModel(null, "Vietnamese", "vi"),
                VslTemplate2LanguageModel(null, "Thai", "th"),
            ),
    ...
    private fun getQuestionConfig(): QuestionConfig {
        return QuestionConfig(
            ...
            listOf(
                ...
                VslTemplate2AnswerModel(R.string.title_answer_C)
            ),
            nativeAd1 = NativeAdConfig(
                nativeAdIds = listOf(
    ...
    override fun nextScreen(context: Context, data: Bundle?) {
        ...
        val selectedLanguageCode =
            data?.getString(VslTemplate2FirstOpenSDK.ARG_KEY_SELECTED_LANGUAGE_CODE)
